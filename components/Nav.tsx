    ...
    return (
        <div className="flex w-full relative">
            ...
            <div className="hidden md:flex items-center ml-5 gap-2 text-xs md:text-base lg:text-lg w-2/3">
                ...
                <Link href="/about" className="p-5 hover:text-blue-400 hover:scale-125">About</Link>
            ...
            { isOpen ?
                ...
                <Link href="/about" className="p-5 hover:text-blue-400 hover:scale-125" onClick={handleClick}>About</Link>
